 ...
 *
 *  !! Из-за несовместимости модулей пришлось вынести css стили слайдера прямо
 *     к нам (файл swiper-bundle.min.css)
 *     Если будем обновлять Свайпер, нужно будет удостовериться, что мы также
 *     подтянем самый новый файл со стилями. В css файле указана его версия.
 */
